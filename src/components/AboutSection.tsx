...
const ABOUT_TEXT =
"I'm Sudharsan B — a Cloud & DevOps Engineer passionate about building scalable, reliable, and self-healing infrastructure. I specialize in AWS, Kubernetes, Terraform, CI/CD automation, monitoring systems, and cloud-native architecture. I enjoy transforming complex infrastructure challenges into automated, resilient, and production-ready solutions.";
...
return ( <section
 ...
 >
{/* Corner decorative 3D images */} <FadeIn
     delay={0.1}
     x={-80}
     y={0}
     duration={0.9}
      ...
      <FadeIn delay={0.15} className="w-full max-w-3xl">
        <div className="flex flex-col gap-5 sm:gap-6">
          {[
            {
              label: 'Cloud',
              items: ['AWS', 'EC2', 'S3', 'IAM', 'VPC', 'RDS', 'CloudWatch'],
            },
            {
              label: 'DevOps',
              items: ['Docker', 'Kubernetes', 'Terraform', 'CI/CD', 'GitHub Actions', 'Jenkins'],
            },
            {
              label: 'Monitoring & SRE',
              items: ['Prometheus', 'Grafana', 'Alertmanager', 'Cloud Monitoring'],
            },
            {
              label: 'Programming',
            ...
            },
            {
              ...
              items: ['Git', 'GitHub', 'Linux', 'Vercel', 'VS Code'],
            },
          ].map((group) => (
            <div
              key={group.label}
